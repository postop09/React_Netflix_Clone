...
export default function MovieModal({id, backdrop_path, first_air_date, release_date, name, title, vote_average, overview, modalOpen, setModalOpen}) {
  const secOut = useRef();
